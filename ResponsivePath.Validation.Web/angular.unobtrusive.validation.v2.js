            ...
            var ValmsgSummaryDirective = (function () {
                function ValmsgSummaryDirective(validation) {
                    ...
                    this.link = function (scope, element) {
                        ...
                        // Here we don't need to dispose our watch because we have an isolated scope that goes away when the element does.
                        var watch = scope.$parent.$watchCollection(_this.validation.messageArray, function (newValue) {
    ...
    (function (Validation) {
        ...
        (function (Unobtrusive) {
            function defaultTemplates($templateCache) {
                $templateCache.put("templates/angular-unobtrusive-validation/valmsgSummary.html", '<div class="alert alert-error" ng-if="started" ng-show="validationSummary.length">' + '   <ul>' + '       <li data-ng-repeat="err in validationSummary" data-ng-bind-html="err"></span>' + '   </ul>' + '</div>' + '<div class="alert alert-error" ng-transclude ng-if="!started"></div>');
...
//# sourceMappingURL=angular.unobtrusive.validation.v2.js.map