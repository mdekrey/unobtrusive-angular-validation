module ResponsivePath.Validation.Unobtrusive.Tests {
	describe('Unit: Directive val-range', function () {
		...
		beforeEach(() => {
			...
			element = compile('<form><input type="text" data-val="true" name="Target" ng-model="target" data-val-range="Invalid" data-val-range-min="4.2" data-val-range-max="8.7" /></form>')(scope);
